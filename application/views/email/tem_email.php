...
<table border="0" cellpadding="0" cellspacing="0" align="center"
    ...
    <tr>
        <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
            ...
            <img src="<?= base_url('images/logo.png');?>" width="100" style="width: 100%; max-width: 100px">
...
<table border="0" cellpadding="0" cellspacing="0"
    ...
    <tr>
        <td>
            <h2  style="font-family: 'Avenir Next', 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; line-height: 1.65;"><?php if(isset($header)) { echo $header; } ?></h2>
        ...
        <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
            ...
            <tr>
                ...
                style="text-decoration: none;"><img border="0" vspace="0" hspace="0" style="padding: 0; margin: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; border: none; display: inline-block;
                    ...
                    width="30" height="30"
                    src="<?= base_url('images/facebook.png');?>"></a></td>
                ...
                style="text-decoration: none;"><img border="0" vspace="0" hspace="0" style="padding: 0; margin: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; border: none; display: inline-block;
                    ...
                    width="30" height="30"
                    src="<?= base_url('images/instagram2.png');?>"></a></td>             
                ...
                style="text-decoration: none;"><img border="0" vspace="0" hspace="0" style="padding: 0; margin: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; border: none; display: inline-block;
                    ...
                    width="30" height="30"
                    src="<?= base_url('images/linkedin.png');?>"></a></td>      
    ...
    $('#surat').change(function(){
        ...
        $.ajax({
            ...
            success : function(hasil){
                $('#isiTem').html(nl2br(hasil.isi_surat));
            }
        });
    });
