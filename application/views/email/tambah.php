	 ...
	 <div class="row">
        <div class="col-lg-6">	
			 <div class="card shadow mb-4">
				 ...
				 <div class="card-body">
					<form action="<?php echo base_url('email/tambah') ?>" enctype="multipart/form-data" method="POST" >
					 ...
					 <div class="form-group">
						<button type="button" class="btn btn-info btn-block" id="show" name="show"> Show </button>
					 </div>
					 ...
					 <div class="form-group">
						<button type="submit" name="add" id="" class="btn btn-success">Accept</button>
					 </div>
					</form>
				 </div>
			 </div>
