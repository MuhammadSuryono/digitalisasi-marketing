             ...
             <form action="<?php echo base_url('city/tambah') ?>" method="POST" class="row">
                 <div class="col-xl-5 col-md-6 mb-4">
                     <div class="form-group">
                         ...
                         <input type="text" name="city" class="form-control form-control-user <?php if(form_error('nama')){ echo'is-invalid'; } ?>" id="exampleInputEmail" value="<?php echo set_value('nama'); ?>">
                         <?php echo form_error('nama', '<small class="text-danger pl-3">', '</small>'); ?>
                     </div>
                     <?php foreach ($komponen as $db) { ?>
                     <div class="form-group">
                         <label for="user"><?php echo $db['komponen'] ?></label>
                         <input type="text" name="<?php echo $db['id_komponen'] ?>" class="form-control form-control-user " id="exampleInputEmail">
                     </div>
                     <?php } ?>
