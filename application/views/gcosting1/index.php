 ...
 <div class="container-fluid">
     ...
     <!-- Page Heading -->
     <h1 class="h3 mb-4 text-gray-800">Daftar Group Costing Level 1</h1>
     <!-- DataTales Example -->
                 ...
                 <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                     ...
                     <tbody>
                         ...
                         <tr>
                             ...
                             <td><?php echo $data['g_c1'] ?></td>
                             <td><?php echo $data['keterangan'] ?></td>
                             <td>
                                 <center>
                                     <a href="<?php echo base_url(); ?>groupCosting1/hapus/<?php echo $data['id_g_c1']; ?> " class="btn-danger btn-sm tombol-hapus"><i class="fas fa-trash"></i> Delete</a>
     ...
     <div class="modal-dialog" role="document">
         <div class="modal-content">
             ...
             <div class="modal-body">
                 <form method="POST" action="<?php echo base_url('groupCosting1/tambah') ?>">
                     <input type="hidden" name="id" id="id">
                     <div class="form-group">
						 <label>Group Costing 1</label>
                         <input type="text"  name="g_c1" class="form-control form-control-user" aria-describedby="emailHelp" placeholder="">
                     </div>
					 <div class="form-group">
         ...
         <div class="modal-content">
             ...
             <div class="modal-body">
                 <form method="POST" action="<?php echo base_url('groupCosting1/ubah') ?>">
                     ...
                     <div class="form-group">
						 <label>Group Costing 1</label>
                         <input type="text" id="m" name="g_c1" class="form-control form-control-user" aria-describedby="emailHelp" placeholder="">
                     </div>
					 <div class="form-group">
						 <label>Keterangan</label>
