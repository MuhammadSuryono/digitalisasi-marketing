   ...
   <div class="container-fluid">
       ...
       <div class="card shadow mb-4">
           <div class="card-header py-3">
               <h6 class="m-0 font-weight-bold text-primary">Data Project Document</h6>
           </div>
           <div class="card-body">
                            ...
                            ?>
                               <tr>
                                   ...
                                   <td class="text-center align-middle">
                                       <a href="<?php echo base_url('projectDocument/hapus') ?>/<?php echo $data['nomor_rfq'] ?>" class="btn btn-danger btn-sm tombol-hapus" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fas fa-trash fa-sm"></i></a>
