...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Skenario</h1>
    <!-- DataTales Example -->
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <center>
                                    <a href="javascript:;" data-toggle="modal" data-target="#edit-stkbskenario" data-id="<?php echo $data['no']; ?>" data-nm="<?php echo $data['nama'] ?>" data-kt="<?php echo $data['keterangan'] ?>" class="btn-success btn-sm"><i class="fas fa-edit"></i> Edit</a>
                                    <a href="<?php echo base_url(); ?>StkbSkenario/hapus/<?php echo $data['no']; ?> " class="btn-danger btn-sm tombol-hapus"><i class="fas fa-trash"></i> Delete</a>
                                </center>
                            </td>
                        </tr>
                        <?php
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="POST" action="<?php echo base_url('StkbSkenario/tambah') ?>">
...
<div class="modal fade" id="edit-stkbskenario" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="<?php echo base_url('StkbSkenario/ubah') ?>">
