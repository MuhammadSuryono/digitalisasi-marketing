             ...
             <form action="" method="POST" class="row">
                 <div class="col-xl-5 col-md-6 mb-4">
                     <div class="form-group">
                         ...
                         <input type="text" name="nama" class="form-control form-control-user <?php if(form_error('nama')){ echo'is-invalid'; } ?>" id="exampleInputEmail" value="<?php echo $customer['nama']; ?>">
                     ...
                     <div class="form-group">
                         ...
                         <select name="perusahaan" class="selectpicker show-tick form-control <?php if(form_error('perusahaan')){ echo'is-invalid'; } ?>" data-live-search="true" title="Pilih perusahaan...">
                             <?php 
                 ...
                 <div class="col-xl-5 col-md-6 mb-4">
                     ...
                     <div class="form-group row">
						<div class="col-sm-6 mb-3 mb-sm-0">
                         ...
                         <input type="number" name="hp1" class="form-control form-control-user <?php if(form_error('hp1')){ echo'is-invalid'; } ?>" id="exampleInputEmail" value="<?php echo $customer['hp1'];?>">
                         <?php echo form_error('hp1', '<small class="text-danger pl-3">', '</small>'); ?>
						</div>
						<div class="col-sm-6">
						 <label for="user">Phone 2</label>
                         <input type="number" name="hp2" class="form-control form-control-user" id="exampleInputEmail" value="<?php echo $customer['hp2']; ?>">
						</div>
                     </div>
					 ...
					 <div class="form-group row">
						<div class="col-sm-6 mb-3 mb-sm-0">
                         ...
                         <input type="text" name="email1" class="form-control form-control-user <?php if(form_error('email1')){ echo'is-invalid'; } ?>" id="exampleInputEmail" value="<?php echo $customer['email1']; ?>">
                         <?php echo form_error('email1', '<small class="text-danger pl-3">', '</small>'); ?>
						</div>
						<div class="col-sm-6">
						 <label for="user">Email 2</label>
                         <input type="text" name="email2" class="form-control form-control-user" id="exampleInputEmail" value="<?php echo $customer['email2']; ?>">
						</div>
                     </div>
					 
					 <div class="form-group">
                         <label for="user">Catatan</label>
                         <input type="text" name="catatan" class="form-control form-control-user" id="exampleInputEmail" value="<?php echo $customer['catatan']; ?>">
                     </div>
